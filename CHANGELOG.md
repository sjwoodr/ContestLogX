...
- Clamped fallback window geometry to 80% of the current screen, centered, so the app never opens off-screen or larger than the desktop when saved geometry can't be restored
