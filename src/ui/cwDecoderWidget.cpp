...
// The actual header file is qpermissions.h (lowercase). The CamelCase
// umbrella <QPermissions> isn't always generated by syncqt in Qt 6.5
// releases — the explicit lowercase include works across every 6.5+
// patch version (CI's Qt 6.5.* installs failed to find <QPermissions>).
